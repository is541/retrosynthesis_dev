...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--template_rule_path",
        default="../data/uspto_all/template_rules_1.dat",
        type=str,
        help="Specify the path of all template rules.",
    )
    parser.add_argument(
        "--model_path",
        default="../model/saved_rollout_state_1_2048.ckpt",
        type=str,
        help="specify where the trained model is",
    )
